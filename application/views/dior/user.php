...
<div>
    <h2 align="center" dir="rtl">.:به سایت Dior خوش آمدید:.</h2> 
  <p align="center">  <img src="http://localhost:81/ci1/img/diorsauvage.jpg" alt="diorsauvage" width="500"  height="279" ></p> </div>
';

}
else{

	header('location:http://localhost:81/ci1/index.php/m/ulog');
	}
?> 
