...
$sql='select *  from tblperfume where id='.intval($_GET['id']);
      ...
      <p>&nbsp;</p>
       <input type="hidden" name="id"  value="<?php echo $row ['id'];?>"/>
	    <table width="40%" border="0" align="center" cellpadding="5" cellspacing="5" dir="rtl" class="tbl">
	      <tr>
	        <td colspan="3" align="center">ویرایش عطر 
              </td>
          </tr>
	      <tr>
	        <td width="47%" align="center">نام عطر</td>
	        <td colspan="2" align="center"><label for="name"></label>
            <input type="text" name="name" autocomplete="off" value="<?php echo $row ['name'];?>" id="name"></td>
          </tr>
	      <tr>
	        <td align="center">نام سازنده</td>
	        <td colspan="2" align="center"><label for="creator"></label>
            <input type="text" name="creator" autocomplete="off" value="<?php echo $row ['creator'];?>" id="creator"></td>
          </tr>
	      <tr>
	        <td align="center">طبع</td>
	        <td colspan="2" align="center"><label for="nature"></label>
            <input type="text" name="nature" autocomplete="off" value="<?php echo $row ['nature'];?>" id="nature"></td>
          </tr>
	      <tr>
	        <td align="center">جنسیت</td>
	        <td width="26%" align="center"><label for="gender">
	          <input type="radio" name="gender" id="gender2" value="زنانه">
            زنانه</label></td>
